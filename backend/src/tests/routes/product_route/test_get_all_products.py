...
@pytest.mark.asyncio
async def test_get_all_products_sucess(test_app, session, test_app_authentication):
...
@pytest.mark.asyncio
async def test_get_all_products_route_not_fount(test_app, session, test_app_authentication):
